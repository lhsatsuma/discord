...
module.exports = {
    data: (subcommand) =>
        subcommand
            .setName(translate('birthday', 'CMD_REMOVE'))
            .setDescription(translate('birthday', 'CMD_REMOVE_DESCRIPTION'))
    ...
    async execute(interaction) {
        ...
        bean.user_id = interaction.options.getUser('user') ? interaction.options.getUser('user').id : interaction.user.id;getUser
