...
[![MySQL](https://img.shields.io/npm/v/mysql?color=success&label=MySQL)](https://www.npmjs.com/package/mysql)
[![PHP Serialize](https://img.shields.io/npm/v/php-serialize?color=success&label=PHP%20Serialize)](https://www.npmjs.com/package/php-serialize)
...
Copy config.json and fill all tags
